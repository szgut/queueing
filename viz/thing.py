...
class Autotid(object):
	"""Autogenerated id. Smaller that later Autotids and other objects."""
	SEQ = 0
	...
	def __cmp__(self, other):
		if isinstance(other, Autotid):
			return cmp(self.id, other.id)
		else:
			return -1

	def canonical_tid(self):
		return ("autotid", self.id)
